...
def fun_getinrange(x, bound1, bound2):
	if (x < bound1 and bound1 < bound2) or (x > bound1 and x > bound2 and bound1 > bound2):
		return bound1
	elif (x < bound1 and x < bound2 and  bound2 < bound1) or (x > bound1 and x > bound2 and bound1 < bound2):
		return bound2
